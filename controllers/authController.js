...
exports.loginUser = async (req, res) => {
    try {
        ...
        // 1. Buscar al usuario por su email (identificador_acceso)
        ...
        const user = users[0];
         ...
         // 2. Comparar la contraseña escrita con el hash de la base de datos
        ...
        // 3. Si todo está bien, login exitoso
        res.json({
            status: 'success',
        ...
        console.error(error);
        res.status(500).json({ status: 'error', message: 'Error en el login.' });
    }
};